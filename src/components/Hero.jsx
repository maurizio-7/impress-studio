...
function Hero() {
  return (
    <section className="min-h-screen flex items-center px-6 lg:px-20 bg-brand-navy">
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-8 flex gap-4">
            ...
            <Link
              to="/portfolio"
              className="px-8 py-4 border border-white/40 text-white rounded-xl font-semibold hover:bg-white hover:text-brand-navy transition"
            >
              View Our Work
            </Link>
          </div>
